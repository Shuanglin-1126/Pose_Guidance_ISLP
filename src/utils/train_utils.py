...
def parse_configs(config_path: str) -> Tuple[DictConfig, DictConfig, DictConfig, DictConfig, DictConfig, DictConfig, DictConfig, DictConfig]:
    ...
    return rae_config, stage2_config, dataset_config, transport_config, sampler_config, guidance_config, misc, training_config
