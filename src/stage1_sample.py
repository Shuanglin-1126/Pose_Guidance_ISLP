...
DEFAULT_IMAGE = Path(r"F:\SLRdataset\WLASL\origin_frame\00339\0001.jpg")
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        default=r'F:\chexiao\project\RAE\configs\stage1\pretrained\DINOv2-B.yaml',
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path(r"F:\chexiao\project\RAE\result\RAE_002-RAE\stage1.png"),
